    ...
    with left_sec:
        ...
        if sectors:
            ...
            with st.expander("View all 11 day-trading sectors"):
                st.dataframe(dsec.sort_values("strength_score",ascending=False),use_container_width=True,hide_index=True)
        else:
    ...
    with right_sec:
        ...
        if swing_secs:
            ...
            with st.expander("View all 11 swing sectors"):
                st.dataframe(ssec.sort_values("strength_score",ascending=False),use_container_width=True,hide_index=True)
        else:
